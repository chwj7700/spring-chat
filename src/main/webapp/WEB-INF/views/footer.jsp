					...
					<div
						...
						<p class="social text-muted mb-0 pb-0 bold-text">
							<span class="mx-2"><i class="fa fa-facebook"
								...
								class="fa fa-youtube" aria-hidden="true"></i></span> <span class="mx-2"><i
								class="fa fa-twitter" aria-hidden="true"></i></span> <span class="mx-2"><i
								class="fa fa-instagram" aria-hidden="true"></i></span>
						</p>
						<small class="rights"><span>&#174;</span>Today's special
							moments are tomorrow's memories.</small>
					</div>
					<div
						...
						<small> <span><i class="fa fa-envelope"
								aria-hidden="true"></i></span> chwj7700@gmail.com
						</small>
					</div>
